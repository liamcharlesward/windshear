...
export const Text = (props: TextProps) => {
  ...
  const renderText = (textProps: TextProps) => {
    ...
    const TextSize = textProps.size ? GlobalTextSizePresets[textProps.size] : "";
    const Boldness = textProps.boldness ? GlobalTextWeightPresets[textProps.boldness] : "";
    ...
    return (
      <div
        ...
        className={clsx(TextSize, Boldness)}
      >
        {textProps.text}
      </div>
    );
